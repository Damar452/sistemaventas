...
<div class="header bg-secondary pb-6">
    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            <h6 class="h2 text-black d-inline-block mb-0">Creditos</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
             <a href="<?php  echo base_url(); ?>ventas" class="btn btn-outline-success">Ventas</a>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table id="credictTable" class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort">Abonado</th>
                    <th scope="col">Ver</th>
                ...
                <tbody class="list">
                  ...
                  <?php if(!empty($data)):?>
                    ...
                    <tr>
                      ...
                      <td class="abonos">
                        <span class="badge badge-dot mr-4">
                          <span class="status"><?php echo $value->abonos; ?></span>
                        </span>
                      </td>
                      <td class="text-center">
                        <a href="<?php echo base_url(); ?>credito/<?php echo $value->id; ?>"  >
                        <i class="fa fa-desktop" aria-hidden="true" style="color:#5E72E4; font-size:20px; "></i>
