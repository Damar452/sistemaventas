...
<div class="header bg-secondary pb-6">
    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            <h6 class="h2 text-black d-inline-block mb-0">Gastos</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
            <a href="<?php echo base_url(); ?>nuevo-gasto" class="btn btn-success">Registrar Gasto</a>
        </div>
        </div>
    </div>
    </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table id="gastoTable" class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                  <th scope="col" class="sort">N°</th>
                    <th scope="col" class="sort">Descripcion</th>
                    <th scope="col" class="sort">Valor</th>
                ...
                <tbody class="list">
                  ...
                  <?php if(!empty($data)):?>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="badge badge-dot mr-4">
                          <span class="status"><?php echo "$".$value->valor; ?></span>
                        </span>
                      </td>
