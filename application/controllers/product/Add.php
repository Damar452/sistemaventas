...
class Add extends CI_Controller {
    ...
    public function save(){
        ...
        // $this->form_validation->set_rules("barcode","Código de producto","required|numeric|is_unique[product.barcode]");
        $this->form_validation->set_rules("name","Nombre","required");
        // $this->form_validation->set_rules("description","Descripción","required");
        $this->form_validation->set_rules("price","Precio de venta","required|numeric"); //le quite el decimal obligatorio |decimal
        $this->form_validation->set_rules("p_compra","Precio de compra","required|numeric");
