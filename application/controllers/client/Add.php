...
class Add extends CI_Controller {
    ...
    public function save(){
        ...
        $this->form_validation->set_rules("numDocument","Número de documento","is_unique[client.num_document]");
		...
		if ($this->form_validation->run()==TRUE) {
            ...
            echo "<script>javascript:window.history.go(-2);</script>"; // redirigir dos veces atras 
